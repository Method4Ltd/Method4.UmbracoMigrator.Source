...
module.exports = {
    ...
    plugins: [
        new CopyPlugin({
            patterns: [
                {
                    from: "./App_Plugins/Method4UmbracoMigratorSource/",
                    to: path.join(__dirname, "../Method4.UmbracoMigrator.Source.SampleSite/App_Plugins/Method4UmbracoMigratorSource/"),
                    toType: "dir",
